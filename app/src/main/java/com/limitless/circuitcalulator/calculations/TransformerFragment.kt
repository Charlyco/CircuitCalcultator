 ...
 * Use the [TransformerFragment.newInstance] factory method to
...
class TransformerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_transformer, container, false)
    }
